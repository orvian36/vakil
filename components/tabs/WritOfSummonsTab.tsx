...
const tabConfig = getTabConfig('writ-of-summons');

interface WritOfSummonsTabProps {
  caseId: string;
  caseData: Case;
  content?: string;
...
export default function WritOfSummonsTab({ 
  caseId, 
  caseData,
  content: propContent = '',
  isGenerating: propIsGenerating = false,
}: WritOfSummonsTabProps) {
  ...
  const getInitialContent = () => {
    return `# Failed to generate Writ of Summons`;
  };
