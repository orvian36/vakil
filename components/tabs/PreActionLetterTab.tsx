...
const tabConfig = getTabConfig('pre-action-letter');

interface PreActionLetterTabProps {
  caseId: string;
  caseData: Case;
  content?: string;
...
export default function PreActionLetterTab({ 
  caseId, 
  caseData,
  content: propContent = '',
  isGenerating: propIsGenerating = false,
}: PreActionLetterTabProps) {
  ...
  const getInitialContent = () => {
    return `# Failed to generate Pre-Action Letter`;
  };
