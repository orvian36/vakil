...
export default function RegenerateModal({ 
  ...
  const getDocumentTypeName = (type: string) => {
    switch (type) {
      case 'summary': return 'Statment of Claim';
      case 'witness': return 'Witness Statement';
      case 'chronology': return 'Pre-action Letter';
      case 'exhibits': return 'Statement of Damages';
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              <h2 className="text-xl font-semibold text-[var(--color-ink-950)]">
                Regenerate {getDocumentTypeName(documentType)}
              </h2>
              <p className="text-sm text-[var(--color-ink-500)] mt-1">
                Provide any modifications or additional requirements
              </p>
            </div>
          </div>
          <button
          ...
          <div className="p-6 flex-1 overflow-y-auto">
            ...
            <div>
              ...
              <textarea
                ...
                placeholder="e.g., Add more details about medical expenses, Include specific legal precedents, Focus more on the timeline of events, etc."
